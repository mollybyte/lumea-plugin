...
1. Все имена тикетов в ответе давай как `#` + первые 8 символов uuid (первая группа), плюс полный uuid отдельным списком, чтобы основной разговор мог сразу вызвать инструменты.
